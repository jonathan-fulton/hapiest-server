...
class ServerConfig extends VO {
     ...
     * @param {string} [serverConfig.sslCertFolder]
    ...
    constructor(serverConfig) {
        ...
        serverConfig.sslEnabled = serverConfig.sslEnabled || false;
        serverConfig.sslCertFolder = serverConfig.sslCertFolder || null;
        serverConfig.redirectHttpToHttps = serverConfig.redirectHttpToHttps || false;
        serverConfig.redirectPort = serverConfig.redirectPort || null;
